...
<div class="wrapper fadeInDown">
  <div id="formContent">
    ...
    <div id="formFooter">
      <a class="underlineHover" href="owner-reg.php">Create Account</a>
    </div>
...
//remove nalang yung accstatus kung gusto maglog in
            if ($row['username'] === $username && $row['password'] === $password && $row['accstatus'] === 'approved') {

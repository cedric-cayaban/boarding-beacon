...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    // Check if 'file' key exists in the $_FILES array and if there are no upload errors
    if (isset($_FILES['permit']) && $_FILES['permit']['error'] == UPLOAD_ERR_OK) {
        $file = $_FILES['permit']['name'];
        $tempname = $_FILES['permit']['tmp_name'];
        $folder = "permits/" . $file;
                ...
                echo '<script>
                    document.addEventListener("DOMContentLoaded", function () {
                        Swal.fire(
                            ...
                            window.location.href = "user-type-login.php";
                        });
                    });
                </script>';
            } else {
        ...
        print_r($_FILES);
        // 'file' key is not set or there was an error in the file upload
        echo '<script>
            document.addEventListener("DOMContentLoaded", function () {
                Swal.fire(
                    "Error!",
...
<body>
    ...
    <div class="wrapper">
       ...
       <form action="owner-reg.php" method="post" enctype="multipart/form-data" class="field-input1"  >
            <div class="top-inp">
            ...
            <div class="permits">
                <label for="">Enter Business Permit</label>

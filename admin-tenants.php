    ...
    <header>
       ...
       <nav class="navbar navbar-expand-sm navbar-dark">
            ...
            <ul class="navbar-nav">
                ...
                <li class="nav-item">
                    <a class="nav-link active" href="#">Tenants</a>
                </li>
                <li class="nav-item">
                    <a class="nav-link" href="admin-owner.php">Owners</a>
                </li>
...
<?php
$query = "SELECT tenant.tenantID, tenant.username, tenant.password, tenant.fname, tenant.lname, tenant.midname FROM tenant";
